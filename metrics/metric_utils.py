...
LOCAL_DETECTOR_PATH = os.environ.get('FID_DETECTOR_PATH', './utils/weights/inception-2015-12-05.pt')
...
def compute_feature_stats_for_generator(opts, detector_url, detector_kwargs, rel_lo=0, rel_hi=1, batch_size=64, batch_gen=None, jit=False,trigger=False, **stats_kwargs):
    ...
    while not stats.is_full():
        ...
        for _i in range(batch_size // batch_gen):
            ...
            if trigger : 
                ...
                gen_z_masked[:, idx] = gen_z_masked[:, idx]*0 + c_value
                z = gen_z_masked
                ###############################
